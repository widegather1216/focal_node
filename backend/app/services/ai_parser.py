...
GEMMA_SYSTEM_PROMPT = (
    ...
    "2. 감각적이고 명확한 캡션 (Caption): 상투적인 미사여구나 과장된 표현은 지양하되, 사진의 피사체 상태, 핵심 위치, 시간대, 빛의 방향, 전반적인 분위기를 구체적으로 담아내십시오. 이미지를 보지 않고 캡션만 읽더라도 눈앞에 정밀한 장면이 그려지도록, 시각적 사실과 감각적 분위기가 조화를 이루는 1~2문장으로 작성하십시오.\n"
